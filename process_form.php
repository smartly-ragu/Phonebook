...
$user=$_SESSION['email'];
$sel5="select * from users where email='$user'";
        
$query1 = mysqli_query($db,$sel5);
...
if ($mode == "add_new" ) {
  ...
  if (!$error) {
    $sql = "INSERT INTO `tbl_contacts` (`first_name`, `middle_name`,`userid`, `last_name`, `address`, `contact_no1`, `contact_no2`, `email_address`, `profile_pic`) VALUES "
            . "( :fname, :mname, :userid, :lname, :address, :contact1, :contact2, :email, :pic)";
